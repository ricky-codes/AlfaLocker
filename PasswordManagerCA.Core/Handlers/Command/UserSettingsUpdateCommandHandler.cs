...
{
    public class UserSettingsUpdateCommandHandler : IRequestHandler<UserSettingsUpdateCommand, UserSettingsUpdateCommand>
    {
        ...
        public UserSettingsUpdateCommandHandler(IMediator mediator, IRepository repository, IPasswordHasher passwordHasher)
        {
        ...
        public async Task<UserSettingsUpdateCommand> Handle(UserSettingsUpdateCommand request, CancellationToken cancellationToken)
        {
            try
            {
